<aside class="sidebar sidebar--lg sidebar--app" data-stisla-sidebar>
          ...
          <li class="sidebar__item">
            <a class="sidebar__button" href="#">
              ...
              >
                ...
                <ellipse cx="9.001" cy="17.001" fill="currentColor" rx="7" ry="4" /></svg
              ><span>Customers</span>
            </a>
          </li>
        </ul>
        ...
        <ul class="sidebar__list">
          <li class="sidebar__item" data-state="closed">
            ...
            <div class="sidebar__submenu" id="nav-reports">
              <ul class="sidebar__list">
                <li class="sidebar__item">
                  <a class="sidebar__button" href="#"><span>Sales</span></a>
                </li>
                <li class="sidebar__item">
                  <a class="sidebar__button" href="#"><span>Traffic</span></a>
                </li>
                <li class="sidebar__item">
                  <a class="sidebar__button" href="#"><span>Inventory</span></a>
                </li>
              </ul>
            </div>
          </li>
  ...
  <footer class="sidebar__footer">
    ...
    <div class="copyright text-center py-2">
      <hr
        class="separator my-3 border-neutral-200 dark:border-neutral-800"
      />
      <p class="text-[10px] text-neutral-400">
        Designed by <a href="https://nauv.al" class="hover:underline" target="_blank">Nauval</a>
      </p>
    </div>
  </footer>
</aside>
