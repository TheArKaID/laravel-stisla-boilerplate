<header class="navbar border-b border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 text-neutral-900 dark:text-neutral-100 px-6 py-3">
  <!-- Mobile Sidebar Toggle -->
  <button
    type="button"
    class="button button--ghost button--neutral button--icon-only button--flush-start lg:hidden mr-2"
  ...
  <!-- Left Side: Brand on mobile, Search on desktop -->
  ...
  <div class="ms-auto">
    <div class="flex gap-1 items-center">
      ...
      <div class="relative">
        ...
        <span
          class="indicator indicator--warning indicator--pulse absolute top-0 right-0 translate-x-1/3 -translate-y-1/3"
        ></span>
      </div>
      <div
      ...
      >
        <div class="popover__header">
          <h3 class="popover__title">Messages</h3>
        ...
        <div class="popover__body">
          <a href="#" class="media media--unread items-start">
            ...
            <div class="media__content">
              <div class="media__title font-medium text-xs text-neutral-900 dark:text-neutral-100">Joseph Cooper</div>
              <div class="media__description text-xs text-neutral-500">Pushed 3 commits to atlas/main.</div>
              <div class="media__meta text-[10px] text-neutral-400">2 minutes ago</div>
            </div>
          </a>
          <a href="#" class="media items-start">
            ...
            <div class="media__content">
              <div class="media__title font-medium text-xs text-neutral-900 dark:text-neutral-100">Sarah Chen</div>
              <div class="media__description text-xs text-neutral-500">Can you review the Q3 report draft?</div>
              <div class="media__meta text-[10px] text-neutral-400">1 hour ago</div>
            </div>
          </a>
        </div>
      ...
      <div class="relative">
        ...
        <span class="indicator indicator--danger indicator--pulse absolute top-0 right-0 translate-x-1/3 -translate-y-1/3"></span>
      </div>
      <div
              ...
              <span class="icon-box icon-box--primary"
                ...
                >
                  <g fill="none" stroke="currentColor" stroke-width="1.5">
                    ...
                    />
                    <path
                      d="M7.5 18a1.5 1.5 0 1 1 0 3a1.5 1.5 0 0 1 0-3ZM5 6h11.45c2.055 0 3.083 0 3.528.674c.444.675.04 1.619-.77 3.508l-.429 1c-.378.882-.567 1.322-.942 1.57c-.376.248-.856.248-1.815.248H5"
                    />
                  </g></svg
              ></span>
            </div>
            <div class="media__content">
              <div class="media__title font-medium text-xs text-neutral-900 dark:text-neutral-100">New order #10428</div>
              <div class="media__description text-xs text-neutral-500">Acme Corp placed an order for 12 items.</div>
              <div class="media__meta text-[10px] text-neutral-400">5 minutes ago</div>
            </div>
          </a>
        </div>
        <div class="popover__footer">
      ...
      <div class="menu relative">
        <button
          type="button"
          class="button button--ghost button--neutral flex items-center gap-2 px-3 py-1.5 rounded-lg"
          data-stisla-menu-trigger="topbarUser"
          aria-haspopup="menu"
          aria-expanded="false"
          aria-controls="topbarUser"
        >
          <span class="hidden sm:inline font-semibold text-xs text-neutral-700 dark:text-neutral-300">Steven Gerrard</span>
          <span class="avatar avatar--sm avatar--circle" data-stisla-avatar>
            <img
              class="avatar__image"
        ...
        <div
          class="menu__popup w-48 p-2 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-xl shadow-xl z-50 mt-1"
          id="topbarUser"
          data-stisla-menu
          role="menu"
          data-state="closed"
        >
          <div class="menu__group" role="group" aria-labelledby="topbarUserHead">
            <h3 class="menu__group-label px-3 py-1 text-[10px] font-bold text-neutral-400 uppercase" id="topbarUserHead">Mateo Alvarez</h3>
            <a href="#" class="menu__item flex items-center gap-2 px-3 py-2 hover:bg-neutral-50 dark:hover:bg-neutral-800/50 rounded-lg text-xs font-semibold" role="menuitem"
              ><svg
                xmlns="http://www.w3.org/2000/svg"
                width="1em"
                height="1em"
          ...
          <hr class="menu__separator border-neutral-100 dark:border-neutral-800 my-1" role="separator" />
          <a href="#" class="menu__item flex items-center gap-2 px-3 py-2 hover:bg-red-50 dark:hover:bg-red-950/20 rounded-lg text-xs font-semibold text-red-600 dark:text-red-400" role="menuitem"
            ><svg
              xmlns="http://www.w3.org/2000/svg"
              width="1em"
              height="1em"
            ...
            >
              ...
              >
                <path
                  d="M9.002 7c.012-2.175.109-3.353.877-4.121C10.758 2 12.172 2 15 2h1c2.829 0 4.242 0 5.122.879C22 3.757 22 5.172 22 8v8c0 2.828 0 4.243-.878 5.121C20.242 22 18.829 22 16 22h-1c-2.828 0-4.242 0-5.121-.879c-.768-.768-.865-1.946-.877-4.121"
                />
