...
(function () {
  ...
  if (document.readyState !== "loading") initOrderForm();
  else document.addEventListener("DOMContentLoaded", initOrderForm);

  document.addEventListener("livewire:navigated", initOrderForm);
})();
